...
const TokenTransfer = () => {
  ...
  const { AddressPages, tokenHeight, erctoken } = useSelector(
    (state) => state.tokens
  );
  ...
  useEffect(() => {
    const lastID = erctoken?.[erctoken.length - 1]?.number;
    dispatch.tokens.getTransactionByAddressERCWithPagination({
      page,
      limit,
      lastID,
    });
  ...
  return (
    <>
      ...
      <div className="px-20 py-8">
          ...
          <div className="flex items-center justify-between py-5 px-[17px]">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[14.5px]">
                Latest {erctoken?.length || 0} from a total of{" "}
            ...
            <div className="flex items-center gap-2">
              <div
                onClick={() =>
                  downloadAsCSV(erctoken, `erc20_page_${page}.csv`)
                }
                  ...
                  >
                   ...
                   hover:border-dotted"
                    ...
                    <td className="text-[12.5px] text-bryt-primary-main capitalize">
                      <div>{shortenString(nft?.token_address)}</div>
                    </td>
        ...
        {erctoken && erctoken?.length > 0 && AddressPages > 0 && (
          <div className="flex items-center justify-between py-5 px-[17px]">
